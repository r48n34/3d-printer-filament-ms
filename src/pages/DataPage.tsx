...
export function DataPage() {
    ...
    const restore = () => {
        ...
        modals.openConfirmModal({
            ...
            children: (
                <Stack gap="xs">
                    <Text size="sm">
                        This will replace the current {spools.length} spools and
                        all related history with the contents of{" "}
                        <strong>{fileName}</strong>.
                    </Text>
                    <Alert color="orange" icon={<IconInfoCircle size={17} />}>
                        Download a backup first if you may need the current data
                        again.
                    </Alert>
                </Stack>
            ),
            ...
            onConfirm: async () => {
                try {
                    ...
                    notifications.show({
                        ...
                        message:
                            "Your local filament library has been replaced.",
                    });
                } catch {
                    notifications.show({
                        color: "red",
    ...
    return (
        <Stack gap="xl">
            ...
            >
                Spoolbook stores its data in IndexedDB inside this browser.
                Nothing is uploaded, but clearing browser storage can remove
                it—download backups regularly.
            </Alert>
                    ...
                    <Stack gap="md" h="100%">
                        ...
                        <div>
                            ...
                            <Text c="dimmed" size="sm" mt={5}>
                                Exports spools, prints, and adjustments as one
                                versioned JSON file.
                            </Text>
                        </div>
                        <List size="sm" c="dimmed" spacing="xs">
                            <List.Item>
                                Includes archived spools and full history
                            </List.Item>
                            <List.Item>
                                Readable only after explicit restore
                                confirmation
                            </List.Item>
                        </List>
                        <Button
                ...
                <Card withBorder radius="lg" p="xl">
                    <Stack gap="md">
                        ...
                        <div>
                            ...
                            <Text c="dimmed" size="sm" mt={5}>
                                Select a Spoolbook JSON file. It is validated
                                ...
                                <Group wrap="nowrap" align="flex-start">
                                    ...
                                    <div>
                                        ...
                                        <Text size="xs" c="dimmed" mt={3}>
                                            {preview.spools.length} spools ·{" "}
                                            {preview.prints.length} prints ·{" "}
